...
# https://www.youtube.com/watch?v=HGgdcKbC5ro&t=101s
  
# Points to remember:
# 1: Pay attention to initial even number array case. We always need overlap when
# slicing the array.
# Dry run this
# arr1 = [1, 2, 3, 6] 
# arr2 = [4, 6, 8, 10] 
# 2: Look at size = int(n/2) + 1 always. So that you avoid all messy low, high kind of logic.
